...
import { X, Shield, Mail, User as UserIcon, Lock } from "lucide-react";
        ...
        >
            <div className="bg-slate-900 px-8 py-10 text-white relative overflow-hidden">
                ...
                <div className="relative z-10">
                    <h2 className="text-xl font-bold tracking-tight uppercase">Nouvel Agent</h2>
                    <p className="text-slate-400 text-[10px] mt-1 font-bold uppercase tracking-wider">Habilitation d'un collaborateur</p>
                </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="p-8 space-y-6 bg-white">
                ...
                <div className="pt-4 flex gap-3">
                    ...
                    <Button type="submit" className="flex-1 h-12 bg-slate-900 text-white font-bold uppercase tracking-wider rounded-xl">Créer l'accès</Button>
                </div>
            </form>
        </Dialog>
    );
