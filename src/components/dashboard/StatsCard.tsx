        ...
        <Card className="card-premium group relative overflow-hidden">
            ...
            <CardContent className="p-7 relative z-10">
                <div className="flex justify-between items-start mb-6">
                    ...
                    {change !== 0 && (
                        <div className={cn(
                            "flex items-center gap-1 text-[11px] font-black px-2.5 py-1 rounded-lg border shadow-sm transition-transform group-hover:scale-105",
                            trend === "up"
                ...
                <div className="space-y-1">
                    <h3 className="text-4xl font-black tracking-tighter text-slate-900 group-hover:text-primary transition-colors duration-500 leading-none">
                        {value}
                    </h3>
                    <p className="text-[11px] font-black text-slate-400 uppercase tracking-[0.15em] pt-1">
                        {title}
                    </p>
                </div>
                ...
                {description && (
                    <div className="mt-6 pt-5 border-t border-slate-100/50">
                        <p className="text-[11px] text-slate-500 font-medium leading-relaxed opacity-80 group-hover:opacity-100 transition-opacity">
                            {description}
                        </p>
                    </div>
                )}
